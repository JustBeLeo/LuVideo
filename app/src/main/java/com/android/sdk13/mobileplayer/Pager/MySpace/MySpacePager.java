package com.android.sdk13.mobileplayer.Pager.MySpace;
...
import com.android.sdk13.mobileplayer.Pager.MySpace.Adapter.MySpacePagerAdpter;
...
public class MySpacePager extends BasePager {
    ...
    public View initView() {
        View view = View.inflate( mContext, R.layout.pager_myspace, null );
